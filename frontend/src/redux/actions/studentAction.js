...
export const studentUpdatePassword = (passwordData) => {
  return async (dispatch) => {
    try {
      const { data } = await axios.post(
        `${process.env.REACT_APP_BASE_URL}api/student/updatePassword`,
        passwordData
      );
...
export const chatHelper = (name) => {
  return async (dispatch) => {
    try {
      const { data } = await axios.post(`${process.env.REACT_APP_BASE_URL}api/student/getStudentByName`, name);
...
export const getStudentByRegNum = (registrationNumber) => {
  return async (dispatch) => {
    try {
      ...
      const { data } = await axios.post(`${process.env.REACT_APP_BASE_URL}api/student/getStudentByRegNum`, {
        registrationNumber,
      });
...
export const getOTPStudent = (email) => {
  return async (dispatch) => {
    try {
      await axios.post(`${process.env.REACT_APP_BASE_URL}api/student/forgotPassword`, email);
...
export const submitOTPStudent = (credentials) => {
  return async (dispatch) => {
    try {
      const { data } = await axios.post(`${process.env.REACT_APP_BASE_URL}api/student/postOTP`, credentials);
...
export const getAllSubjects = () => {
  return async (dispatch) => {
    try {
      const { data } = await axios.get(`${process.env.REACT_APP_BASE_URL}api/student/getAllSubjects`);
...
export const fetchAttendance = () => {
  return async (dispatch) => {
    try {
      const { data } = await axios.get(`${process.env.REACT_APP_BASE_URL}api/student/checkAttendance`);
...
export const getMarks = () => {
  return async (dispatch) => {
    try {
      const { data } = await axios.get(`${process.env.REACT_APP_BASE_URL}api/student/getMarks`);
